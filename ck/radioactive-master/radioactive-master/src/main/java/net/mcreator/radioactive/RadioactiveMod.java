package net.mcreator.radioactive;
...
@Mod("radioactive")
public class RadioactiveMod {
	public static final Logger LOGGER = LogManager.getLogger(RadioactiveMod.class);
	public static final String MODID = "radioactive";

	public RadioactiveMod() {
		...
		RadioactiveModMobEffects.REGISTRY.register(bus);
